...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-primary via-[hsl(10_90%_60%)] via-25% to-accent relative">
        ...
        <div className="relative container mx-auto px-4 md:py-32 py-[118px]">
          <div className="max-w-3xl mx-auto">
            <div className="space-y-6 text-center">
              <h1 className="text-5xl font-bold leading-tight text-white font-display md:text-8xl">
